...
/**
 * The Class QuickActionTwoState.
 */
public class QuickActionTwoState extends TurnState
{
	
	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 707583939468270703L;

	/**
	 * Instantiates a new quick action two state.
	 *
	 * @param game
	 *            the game
	 * @param view
	 *            the view
	 */
	public QuickActionTwoState(Game game, ConnectionView view)
	{
		super(game, view);
	}
